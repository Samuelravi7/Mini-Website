                        ...
                        <form action="#" method="POST" id="searchForm">
                            <div class="form-group">
                                <input type="text" class="form-control text-center input-lg" id="inputSearch"
                                       name="search"
                                       placeholder="Canon Deskjet 1" autocomplete="off" required/>
                    ...
                    if (res.status == 200) {
                        ...
                        $.each(res.data, function (idx, data) {
                            if (data.fld_product_image === '')
                                data.fld_product_image = data.fld_product_num + '.png';
                            ...
                            $('.list-item').append(`<div class="col-md-4">
                                ...
                                <p>
                                <a target="_blank" href="products_details.php?pid=${data.fld_product_num}" class="btn btn-primary" role="button">View</a>
                                </p>
                                </div>
                                </div>
                                </div>`);
